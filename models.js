...
class StoryList {
  ...
  async removeStory(user, storyId) {
    ...
    // filtering stories, lists, and favorites of user we are removing
...
class User {
  ...
  // adding/removing list of favorites as well as updating API
  // - story: the Story instance to add from favorites
